...
<div className="home__body-container">
    ...
    <img data-src="https://zity.eco/wp-content/uploads/2021/07/descargar-app.svg" alt="descargar-imagen" src="ruta"/>
...
<h4 className="body-instructions">Descarga la app</h4>
    ...
    <div className="home__body-instructions">
    <img data-src="https://zity.eco/wp-content/uploads/2021/07/descargar-app.svg" alt="registrate-imagen" src="ruta"/>
...
<h4 className="body-instructions">Registrate</h4>
    ...
    <div className="home__body-instructions">
    <img data-src="https://zity.eco/wp-content/uploads/2021/07/descargar-app.svg" alt="reserva-imagen" src="ruta"/>
...
<h4 className="body-instructions">Reserva tu estación</h4>
    ...
    <div className="home__body-instructions">
    <img data-src="https://zity.eco/wp-content/uploads/2021/07/descargar-app.svg" alt="coche-imagen" src="ruta"/>
